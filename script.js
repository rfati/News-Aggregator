const API_KEY = 'a2dcea93d42341b58b3e6092b80e7d96';
...
function fetchNews(isSearching) {
    ...
    if (isSearching) {
        ...
        url = `https://newsapi.org/v2/everything?q=${keyword}&language=tr&apiKey=${API_KEY}&page=${currentPage}`;
    } 
            ...
            const newsItem = `
                <div class="newsItem">
                    ...
                    <div class="newsContent">
                        ...
                        <a href="${article.url}" target="_blank">Daha Fazla..</a>
                    </div>
                </div>
            `;
...
function displayNoMoreNews() {
    const newsContainer = document.getElementById('newsContainer');
    newsContainer.innerHTML += '<p>Daha Fazla Haber Yok</p>';
}
